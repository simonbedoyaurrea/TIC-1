  ...
  return (
                ...
                >
                  <div
                    className={`
                      ...
                      h-2.5
                      rounded-full
                      ${cargado ? "bg-emerald-500" : "bg-[var(--text-muted)]"}
                    `}
                  />
    ...
    ${
      !todosListos || cargando
        ...
        : "bg-[var(--accent-red)] text-white border-red-700 hover:brightness-110 hover:border-yellow-500/60 hover:-translate-y-[1px] shadow-lg shadow-red-950/20 cursor-pointer"
    }

    ${cargando ? "animate-pulse opacity-70" : ""}
  `}
          >
            {cargando
              ? "Cargando..."
