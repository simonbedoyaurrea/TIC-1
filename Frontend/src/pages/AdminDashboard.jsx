...
const BLOQUES_UPB = {
  1: "Templo Universitario",
  2: "Aula Magna",
  3: "Bloque Rectoral",
  4: "Colegio UPB Primaria",
  5: "Colegio UPB Bachillerato",
  6: "Economía y Administración",
  7: "Ciencias Sociales",
  8: "Centro Audiovisual CPA",
  9: "Postgrados",
  10: "Arquitectura y Diseño",
  11: "Laboratorios / FORUM",
  12: "Derecho y Ciencias Políticas",
  13: "Editorial y Librería",
  14: "Bienestar Universitario",
  15: "Biblioteca Central",
  16: "Canchas Sintéticas",
  18: "Polideportivo",
  19: "Parqueaderos",
  24: "Puestos de Estudio",
  50: "Centro de Familia",
  51: "Casa de Institutos",
  52: "Conciliación y Arbitraje",
  53: "Casa de Transferencia",
  54: "Casa Bioingeniería",
  55: "Casa GIA",
};
...
const MOCK_REPORTES = [
  {
    id: 1,
    rol: "ESTUDIANTE",
    contacto: "ana@upb.edu.co",
    numeroBloque: 6,
    nombreBloque: "Economía y Administración",
    salon: "301",
    piso: "3",
    inhabilitado: true,
    categoria: "Eléctrico",
    subcategoria: "Lámpara / Bombillo",
    descripcion:
      "Tres lámparas del salón 301 están quemadas, la clase queda completamente a oscuras.",
    urgencia: "HIGH",
    estado: "PENDIENTE",
    notaAdmin: null,
    evidencias: [],
    fechaCreacion: "2026-03-05T08:30:00",
    fechaActualizacion: "2026-03-05T08:30:00",
    fechaResolucion: null,
  },
  {
    id: 2,
    rol: "DOCENTE",
    contacto: "prof@upb.edu.co",
    numeroBloque: 10,
    nombreBloque: "Arquitectura y Diseño",
    salon: "Lab 2",
    piso: "1",
    inhabilitado: false,
    categoria: "Tecnología",
    subcategoria: "Proyector / Video beam",
    descripcion:
      "El videobeam del laboratorio 2 no enciende desde hace una semana.",
    urgencia: "CRITICAL",
    estado: "EN_PROCESO",
    notaAdmin: "Técnico asignado, revisión programada.",
    evidencias: [],
    fechaCreacion: "2026-03-04T14:00:00",
    fechaActualizacion: "2026-03-06T09:00:00",
    fechaResolucion: null,
  },
  {
    id: 3,
    ...
    contacto: null,
    numeroBloque: 15,
    nombreBloque: "Biblioteca Central",
    salon: "Sala Silencio",
    piso: "2",
    inhabilitado: false,
    categoria: "Sanitario",
    subcategoria: "Grifo con fuga",
    descripcion:
      "El grifo del baño de la sala de silencio tiene fuga constante.",
    urgencia: "MEDIUM",
    estado: "RESUELTO",
    notaAdmin: "Reparado por fontanero el 06/03.",
    evidencias: [],
    fechaCreacion: "2026-03-01T10:00:00",
    fechaActualizacion: "2026-03-06T16:00:00",
    fechaResolucion: "2026-03-06T16:00:00",
  },
  {
    id: 4,
    rol: "ESTUDIANTE",
    ...
    subcategoria: "Techo / Goteras",
    descripcion:
      "Hay una gotera grande en el techo del salón 201 cuando llueve.",
    urgencia: "CRITICAL",
    estado: "PENDIENTE",
    notaAdmin: null,
    evidencias: [],
    fechaCreacion: "2026-03-06T07:45:00",
    fechaActualizacion: "2026-03-06T07:45:00",
    fechaResolucion: null,
  },
  {
    id: 5,
    rol: "DOCENTE",
    contacto: "carlos@upb.edu.co",
    numeroBloque: 11,
    nombreBloque: "Laboratorios / FORUM",
    salon: "Lab Redes",
    piso: "1",
    inhabilitado: false,
    categoria: "Tecnología",
    subcategoria: "Red WiFi",
    descripcion: "Sin señal WiFi en el laboratorio de redes desde el lunes.",
    urgencia: "HIGH",
    estado: "PENDIENTE",
    notaAdmin: null,
    evidencias: [],
    fechaCreacion: "2026-03-06T09:15:00",
    fechaActualizacion: "2026-03-06T09:15:00",
    fechaResolucion: null,
  },
  {
    id: 6,
    ...
    contacto: null,
    numeroBloque: 14,
    nombreBloque: "Bienestar Universitario",
    salon: "Cafetería",
    piso: "1",
    inhabilitado: false,
    categoria: "Limpieza / Higiene",
    subcategoria: "Basura acumulada",
    descripcion: "Contenedores desbordados en la cafetería desde hace 2 días.",
    urgencia: "MEDIUM",
    estado: "EN_PROCESO",
    notaAdmin: "Personal de aseo notificado.",
    evidencias: [],
    fechaCreacion: "2026-03-05T12:00:00",
    fechaActualizacion: "2026-03-06T08:00:00",
    fechaResolucion: null,
  },
];
...
export default function AdminDashboard() {
  ...
  const cargarReportes = useCallback(async () => {
    ...
    try {
      ...
      mostrarNotif("Error al cargar reportes", "error");
    } finally {
      setCargando(false);
    }
  }, [modoOnline, filtros]);
  ...
  const actualizarEstado = async (id, estado, notaAdmin) => {
    if (modoOnline) {
      try {
        ...
        mostrarNotif("Error al actualizar", "error");
        return;
      }
    } else {
      setReportes((prev) =>
    ...
    setReporteSeleccionado((prev) =>
      prev ? { ...prev, estado, notaAdmin } : null,
    );
  ...
  const reportesFiltrados = modoOnline
    ? reportes
    : reportes.filter((r) => {
        if (filtros.estado && r.estado !== filtros.estado) return false;
        if (filtros.urgencia && r.urgencia !== filtros.urgencia) return false;
        if (filtros.bloque && r.numeroBloque !== parseInt(filtros.bloque))
          return false;
        if (
          filtros.categoria &&
  ...
  const stats = {
    ...
    inhabilitados: reportes.filter(
      (r) => r.inhabilitado && ["PENDIENTE", "EN_PROCESO"].includes(r.estado),
    ).length,
  };
        ...
        >
          ...
          <div style={{ display: "flex", gap: 4 }}>
            {[
              ...
              <button
                ...
                style={{
                  background: vista === v.id ? "#e63946" : "transparent",
                  color: vista === v.id ? "#fff" : "#aaa",
                  border: vista === v.id ? "none" : "1px solid #333",
                  padding: "6px 14px",
          ...
          <div
            style={{
              ...
              fontSize: 12,
              fontFamily: "IBM Plex Mono",
              color: modoOnline ? "#22c55e" : "#f59e0b",
            }}
          >
            <span
              style={{
                ...
                height: 8,
                borderRadius: "50%",
                background: modoOnline ? "#22c55e" : "#f59e0b",
        ...
        {notif && (
          <div
            style={{
              ...
              right: 20,
              zIndex: 999,
              background: notif.tipo === "error" ? "#e63946" : "#22c55e",
              color: "#fff",
              padding: "10px 20px",
              fontFamily: "IBM Plex Mono",
              fontSize: 13,
...
function VistaDashboard({ stats, reportes, setVista }) {
  ...
  const urgentes = reportes
    .filter(
      (r) =>
        ["CRITICAL", "HIGH"].includes(r.urgencia) && r.estado === "PENDIENTE",
    )
    .slice(0, 4);
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: 11,
                      fontFamily: "IBM Plex Mono",
                      color: URGENCIA_CONFIG[r.urgencia].color,
                      fontWeight: 600,
                    }}
                  >
                    {URGENCIA_CONFIG[r.urgencia].dot}{" "}
                    {URGENCIA_CONFIG[r.urgencia].label}
                  </span>
                </div>
                <div
                  style={{
      ...
      >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setFiltros((p) => ({ ...p, urgencia: e.target.value }))
            }
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              setFiltros((p) => ({ ...p, bloque: e.target.value }))
            }
          >
            <option value="">Todos</option>
            {Object.entries(BLOQUES_UPB).map(([n, nom]) => (
            ...
            {reportes.map((r, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ padding: "10px 12px" }}>
                    <span
                      style={{ color: uc.color, fontWeight: 700, fontSize: 13 }}
                    >
                      {uc.dot} {uc.label}
                    </span>
                  </td>
...
function VistaMapa({ reportes, onSeleccionar }) {
  ...
  const colorBloque = (num) => {
    ...
    if (rs.some((r) => r.urgencia === "CRITICAL" && r.estado !== "RESUELTO"))
      return "#e63946";
    if (rs.some((r) => r.urgencia === "HIGH" && r.estado !== "RESUELTO"))
      return "#c0392b";
  ...
  const bloques = Object.entries(BLOQUES_UPB).map(([num, nombre]) => ({
    num: parseInt(num),
    nombre,
    reportes: porBloque[parseInt(num)] || [],
      ...
      >
        {bloques.map((b) => (
          <div
            ...
            style={{
              background: bloqueHover === b.num ? b.color : `${b.color}33`,
              border: `2px solid ${b.color}`,
              padding: 12,
              cursor: b.reportes.length > 0 ? "pointer" : "default",
              transition: "all 0.2s",
              position: "relative",
              minHeight: 90,
            }}
            onClick={() =>
              b.reportes.length > 0 && onSeleccionar(b.reportes[0])
            }
          >
            <div
              style={{
                fontFamily: "Bebas Neue",
                fontSize: 28,
                color: bloqueHover === b.num ? "#fff" : b.color,
                lineHeight: 1,
              }}
            >
              {b.num}
            ...
            <div
              style={{
                fontFamily: "Barlow Condensed",
                fontSize: 11,
                color: bloqueHover === b.num ? "#fff" : "#888",
                lineHeight: 1.3,
                marginTop: 4,
              }}
            >
            ...
            {b.reportes.some(
              (r) => r.inhabilitado && r.estado !== "RESUELTO",
            ) && (
              <div
                style={{
                  marginTop: 6,
      ...
      >
        ...
        >
          <div>
            ...
            >
              {new Date(reporte.fechaCreacion).toLocaleString("es-CO")}
            </div>
          </div>
          <button
            onClick={onCerrar}
        ...
        >
          ...
          <Seccion titulo="UBICACIÓN">
            <Fila
              label="Bloque"
              valor={`${reporte.numeroBloque} — ${reporte.nombreBloque}`}
            />
          ...
          <Seccion titulo="REPORTANTE">
            ...
            <Fila
              label="Contacto"
              valor={reporte.contacto || "No proporcionado"}
            />
          </Seccion>
          ...
          >
              ...
              >
                {Object.entries(ESTADO_CONFIG).map(([k, v]) => (
                  <button
                    ...
                    style={{
                      background: nuevoEstado === k ? v.bg : "transparent",
                      border: `2px solid ${nuevoEstado === k ? v.color : "#333"}`,
                      color: nuevoEstado === k ? v.color : "#555",
                      padding: "8px 6px",
                      fontFamily: "Barlow Condensed",
                      fontSize: 13,
                      fontWeight: 700,
            ...
            <button
              ...
              style={{
                width: "100%",
                background: guardando ? "#333" : "#e63946",
                color: "#fff",
                border: "none",
                padding: "12px",
                fontFamily: "Bebas Neue",
...
function Fila({ label, valor }) {
  return (
    ...
    >
      ...
      <span style={{ color: "#ddd", textAlign: "right", maxWidth: 280 }}>
        {valor}
      </span>
    </div>
  );
